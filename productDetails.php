...
<body>
    ...
    <div class="row">
        <?php
        $product_id = $_GET['id'];
        $stmt = $db->prepare("SELECT * FROM `kits_products` WHERE `kits_product_id` = $product_id");
        $stmt->execute();
        $datas = $stmt->fetchAll();
                ...
                <div class="card hoverable animated slideInUp wow">
                    <div class="card-image">
                        <a href="productDetails.php?id=<?= $id_product; ?>">
                            ...
                            <a href="productDetails.php?id=<?= $id_product; ?>" class="btn-floating halfway-fab waves-effect waves-light right"><i class="material-icons">koupit</i></a>
                    </div>
